...
<nav class="sidebar-nav">
    ...
    <ul id="sidebarnav">
        ...
        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="mess-menu.php"
        aria-expanded="false"><i class="fas fa-utensils"></i><span
        class="hide-menu">Mess Menu</span></a></li>
        ...
        class="hide-menu">Submit Complaint</span></a></li>

        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="leave-request.php"
        aria-expanded="false"><i class="fas fa-calendar-alt"></i><span
        class="hide-menu">Leave Request</span></a></li>
