...
<nav class="sidebar-nav">
    ...
    <ul id="sidebarnav">
        ...
        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="manage-complaints.php"
        aria-expanded="false"><i class="fas fa-exclamation-circle"></i><span
        class="hide-menu">Manage Complaints</span></a></li>

        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="manage-leave-requests.php"
        aria-expanded="false"><i class="fas fa-calendar-alt"></i><span
        class="hide-menu">Manage Leave Requests</span></a></li>

        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="manage-mess-menu.php"
        aria-expanded="false"><i class="fas fa-utensils"></i><span
        class="hide-menu">Manage Mess Menu</span></a></li>
